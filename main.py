...
st.caption(
    "나이스(NEIS) 교육정보 개방 API로 학교 급식을 조회하고 비교합니다."
)

st.info(
    "학교 이름으로 검색한 뒤 3곳 이상을 선택하면 "
    "같은 날짜의 중식을 비교할 수 있습니다."
)
...
if len(compare_labels) < 3:
    ...
    st.caption(
        "이 그래프로 알 수 있는 것: "
        "같은 날짜에 학교별 급식 칼로리와 메뉴 수를 비교할 수 있습니다."
    )
